...
import com.nailah.githubsubmissionsec.databinding.ActivityMainBinding
import com.nailah.githubsubmissionsec.domain.data.model.ItemsItem
import com.nailah.githubsubmissionsec.view.detail.dashboard.DetailActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getSearchData() {
        mainBinding.svBar.setOnQueryTextListener(object: SearchView.OnQueryTextListener{
